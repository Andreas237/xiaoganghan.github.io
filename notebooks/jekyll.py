...
c.MarkdownExporter.template_path = ['/Users/hanxiaogang/dev/xiaoganghan.github.io/notebooks'] # point this to your jekyll template file
...
def path2support(path):
    ...
    return '{{ BASE_PATH }}/img/notebooks/' + os.path.basename(path)

c.MarkdownExporter.filters = {'path2support': path2support}

if f:
    c.NbConvertApp.output_base = f.lower().replace(' ', '-')
    c.FilesWriter.build_directory = '/Users/hanxiaogang/dev/xiaoganghan.github.io/notebooks' # point this to your build directory
